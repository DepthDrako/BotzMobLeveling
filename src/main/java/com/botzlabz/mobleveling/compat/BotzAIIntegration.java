 ...
 * The supported cross-mod path is botz_lib's capability token:
 * {@code entity.getCapability(BotzLibCapabilities.STAT_HOLDER)} — registered
 * by {@link com.botzlabz.mobleveling.BotzMobLeveling#registerCapabilities}.
 */
public final class BotzAIIntegration {

    public static final boolean EIDOLON_AI_LOADED =
        ModList.get().isLoaded("botz_ai");
